...
InputController::InputController(int32_t joystick_index,
                                 bool map_keyboard_to_this)
    : _joystick_index{joystick_index}, _is_keyboard_holder{
                                           map_keyboard_to_this} {
  std::cout << "Joystick connected : " << joystick_index
            << ", Keyboard : " << map_keyboard_to_this << std::endl;
}
...
bool InputController::has_joystick() {
  return _joystick_index != UNDEFINED_CONTROLLER;
}
